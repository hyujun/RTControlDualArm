...
// {w_x, w_y, w_z, // joint axis twist
// q_x, q_y, q_z,  // joint axis position w.r.t., space coordinate
// l_x, l_y, l_z}
...
// -----------------------
		{0, 0, 1,
				0.0, 0.0, 303.1e-3,
				0.0, 0.0, 500.0e-3},			    // Joint1
		{0, -1, 0,
				0.0, 0.0, 500.0e-3,
				0.0, -125.0e-3, 685.65e-3},		// Joint2
//-----------------------
//Right-side arm
// -----------------------
		{0, 0, -1,
				0.0, -125.0e-3, 685.65e-3,
				0.0, -177.65e-3, 800.0e-3},		// Joint3
		{0, 1, 0,
				0.0, -177.65e-3, 800.0e-3,
				0.0, -325.0e-3, 800.0e-3},		// Joint4
		{1, 0, 0,
				0.0, -325.0e-3, 800.0e-3,
				0.0, -325.0e-3, 585.75e-3},		// Joint5
		{0, 0, 1,
				0.0, -325.0e-3, 585.75e-3,
				-24.5e-3, -325.0e-3, 400.0e-3},   // Joint6
		{0, 1, 0,
				-24.5e-3, -325.0e-3, 400.0e-3,
				0.0, -325.0e-3, 260.0e-3},		// Joint7
		{0, 0, 1,
				0.0, -325.0e-3, 260.0e-3,
				0.0, -325.0e-3, 29.0e-3+306e-3},	// Joint8
		{1, 0, 0,
				0.0, -325.0e-3, 169.0e-3,
				0.0, -299.52e-3, -120.8e-3},		// Joint9, Wrist1
//-----------------------
//Left-side arm
//-----------------------
		{0, 0, -1,
				0.0, 125.0e-3, 685.65e-3,
				0.0, 215.0e-3, 800.0e-3},		    // Joint10
		{0, -1, 0,
				0.0, 177.65e-3, 800.0e-3,
				0.0, 325.0e-3, 800.0e-3},		    // Joint11
		{1, 0, 0,
				0.0, 325.0e-3, 800.0e-3,
				0.0, 325.0e-3 ,558.0e-3},		    // Joint12
		{0, 0, 1,
				0.0, 325.0e-3, 585.75e-3,
				-24.5e-3, 325.0e-3, 400.0e-3},	// Joint13
		{0, -1, 0,
				-24.5e-3, 325.0e-3, 400.0e-3,
				0.0, 325.0e-3, 245.0e-3},		    // Joint14
		{0, 0, 1,
				0.0, 325.0e-3, 260.0e-3,
				0.0, 299.5e-3, 2.21e-3+306e-3},	// Joint15
		{0, -1, 0,
				0.0, 325.0e-3, 179.0e-3,
				0.0, 325.0e-3, 122.19e-3},		// Joint16, Wrist2
};

//{MASS,
// J_Ixx, J_Ixy, J_Ixz, J_Iyy, J_Iyz, J_Izz, //Inertia w.r.t., CoM coordinate
// CoM_x, CoM_y, CoM_z}, //CoM w.r.t., space coordinate
...
// -----------------------
		...
		{10.901,
				0.1614, -0.0006, 0.0026, 0.0558, -0.0059, 0.1339,
...
FrictionTanh frictiontanh[] = {
		...
		{2.444, 3.931, 159.1, 3.963, 77.64, 0.0543}, 		//9, wrist1

		{1.287, 1.641, 165.9, 7.541, 19.43, 0.1302}, 		//10
		{19.99, 35.09, 64.18, 17.6, 36.34, 2.398e-7}, 		//11
		{2.069, 59.79, 95.02, 18.5, 3.299, 2.49e-7}, 		//12
		{325.2, 22, 22.72, 4.02, 28.35, 0.07359}, 			//13
		{2.444, 3.931, 159.1, 3.963, 77.64, 0.0543}, 		//14
		{2.444, 3.931, 159.1, 3.963, 77.64, 0.0543}, 		//15
		{2.444, 3.931, 159.1, 3.963, 77.64, 0.0543}, 		//16, wrist2
};
