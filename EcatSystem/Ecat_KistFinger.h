...
#ifndef ECATSYSTEM_ECAT_KIST_FINGER_H_
...
public:
    ...
    void SetVelocityTarget(int16_t *_Velocity)
    {
    	for(int i=0; i<4; i++)
    	{
    		command[i] = _Velocity[i];
    	}
    }
     ...
     * @return state_
     */
    int GetDeviceState(void) const {return state_;};
	...
	{                                                               //check the state and change the flag of state
		...
		//TxPDO
		case 4:
			MotorPos[0] = EC_READ_S16(domain_address);
			break;
		case 5:
			MotorPos[1] = EC_READ_S16(domain_address);
			break;
		case 6:
			MotorPos[2] = EC_READ_S16(domain_address);
			break;
		case 7:
			MotorPos[3] = EC_READ_S16(domain_address);
			break;
		case 8:
			MotorVel[0] = EC_READ_S16(domain_address);
			break;
		case 9:
			MotorVel[1] = EC_READ_S16(domain_address);
			break;
		case 10:
			MotorVel[2] = EC_READ_S16(domain_address);
			break;
		case 11:
			MotorVel[3] = EC_READ_S16(domain_address);
			break;
		case 12:
			MotorStatus = EC_READ_S16(domain_address);
			break;
		case 13:
			break;
		case 14:
		...
		case 18:
			break;
		case 19:
			timer_tick = EC_READ_U16(domain_address);
			break;
	 ...
	 * @see PDOConfig.h
	 */
    virtual const ec_sync_info_t* syncs() { return &KistHand_syncs[0]; }
    ...
    virtual size_t syncSize() {
        return sizeof(KistHand_syncs)/sizeof(ec_sync_info_t);
    }


    virtual const ec_pdo_entry_info_t* channels() {
        return KistHand_pdo_entries;
    }
